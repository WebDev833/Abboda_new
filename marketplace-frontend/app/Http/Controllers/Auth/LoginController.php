...
class LoginController extends Controller
{
    ...
    public function redirectTo()
    {
            ...
            return $this->redirectTo = route($for[Auth::user()->user_type]);
    }
    ...
    public function login(Request $request)
    {
        ...
        if ($this->attemptLogin($request)) {
            ...
            if($this->sendLoginResponse($request)){
                ...
                return response()->json( route($for[Auth::user()->user_type]));
    ...
    public function showdriverlogin(Request $request)
    {
        ...
        return view('pages.user.auth.driver-login', ['pageConfigs' => $pageConfigs]);
    }
