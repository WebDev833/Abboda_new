...
<div class="col-sm-12 col-xl-12 col-lg-12">
  <div class="card custom-card">
    <div class="card-body">
      <div>
        <h6 class="card-title mb-1">Static Pages List</h6>
        <p class="text-muted card-sub-title">Below is the list of Static pages available for frontend.</p>
      </div>
      ...
      <div class="table-responsive">
        <table class="table table-bordered text-nowrap mb-0">
          ...
          <tbody>
            ...
            @else
              <tr>
                <td colspan="8" class="bg-gray-200"><p class="mb-0 text-center p-3">No Static Pages created yet.</p></td>
              </tr> 
            @endif        
          </tbody>
        </table>
