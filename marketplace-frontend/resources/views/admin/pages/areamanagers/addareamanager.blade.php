...
<!-- End Page Header -->
{!! Form::open(['route'=>'admin.addareamanagersave','method'=>'POST','data-parsley-validate'=>'']) !!}
<div class="row">
        ...
        <div>
          ...
          <div class="">
            <div class="row">
              ...
              <div class="col-lg-12 form-group">
                <label class="form-label">Manager: <span class="tx-danger">*</span></label>
                <div class="parsley-select" id="slWrapper2">
                  {!! Form::select('user_id', $managers, null,["class"=>"form-control select2-search","data-parsley-class-handler"=>"#slWrapper2","data-parsley-errors-container"=>"#slErrorContainer2","data-placeholder"=>"select Manager","required"=>"required"]) !!}
      ...
      <div class="card custom-card">
        <div class="card-body">
          ...
          <div class="mg-t-20">
            ...
            <a class="btn ripple btn-danger pd-x-30 ml-3" href="{{route('admin.areamanagers')}}" >Cancel</a>
          </div>
        </div>
      </div>
    </div>
