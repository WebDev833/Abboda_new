...
<!-- End Page Header -->
{!! Form::open(['route'=>'admin.addareasave','method'=>'POST','data-parsley-validate'=>'']) !!}
<div class="row">
  <div class="col-md-8 col-sm-12">
    <div class="card custom-card">
      <div class="card-body">
        <div>
          <h6 class="card-title mb-2">Area Fields</h6>
            ...
            <div class="row">
              <div class="col-lg-12 form-group">
                ...
                <div class="parsley-select" id="slWrapper4">
                  {!! Form::select('city_id', $cities, null,["class"=>"form-control select2-search","data-parsley-class-handler"=>"#slWrapper4","data-parsley-errors-container"=>"#slErrorContainer4","data-placeholder"=>"select Country","required"=>"required"]) !!}
