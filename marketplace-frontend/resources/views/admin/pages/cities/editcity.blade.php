...
<!-- End Page Header -->
{!! Form::model($city, ['route'=>['admin.editcitysave',$city->id],'data-parsley-validate'=>'']) !!}
@method('PATCH')
<div class="row">
  <div class="col-md-8 col-sm-12">
    <div class="card custom-card">
      <div class="card-body">
        <div>
          <h6 class="card-title mb-2">City Fields</h6>
            ...
            <div class="row">              
              ...
              <div class="col-lg-12 form-group">
                ...
                <div class="parsley-select" id="slWrapper4">
                  {!! Form::select('state_id', $states, null,["class"=>"form-control select2-search","data-parsley-class-handler"=>"#slWrapper4","data-parsley-errors-container"=>"#slErrorContainer4","data-placeholder"=>"select Country","required"=>"required"]) !!}
                    <div id="slErrorContainer4"></div>
                </div>
              </div>
              <div class="col-lg-12 form-group">
                <label class="form-label tx-danger">Region bounds: <span class="tx-danger">*</span></label>
                {!! Form::text('region_bounds', null, ["class"=>"form-control","placeholder"=>"Enter Region Bounds : Location Object","required"=>"required"]) !!}
              </div>
            </div>
            <div class="mg-t-20">
      ...
      <div class="card custom-card">
        <div class="card-body">
          ...
          <div class="mg-t-20">
            ...
            <a class="btn ripple btn-danger pd-x-30 ml-3" href="{{route('admin.countries')}}" >Cancel</a>
          </div>
        </div>
      </div>
    </div>
