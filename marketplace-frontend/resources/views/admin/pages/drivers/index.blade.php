          ...
          <tbody>
            @if ($drivers->count())
                @foreach ($drivers as $driver)
                   <tr>
                    <td>#{!! $driver->id !!}</td>
                    <td>@if(isset($driver->driverprofile->area->name)) {!! Admin::stringColumn($driver->driverprofile->area->name) !!} @endif</td>
                    <td>{!! Admin::stringColumn($driver->name) !!}</td>
                    <td>{!! Admin::stringColumn($driver->phone) !!}</td>
                    <td>{!! Admin::stringColumn($driver->email) !!}</td>
                    <td>@if(isset($driver->driverprofile->vehicle_no)){!! Admin::stringColumn($driver->driverprofile->vehicle_no) !!} @endif</td>
