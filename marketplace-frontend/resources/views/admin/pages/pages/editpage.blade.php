...
<!-- End Page Header -->
{!! Form::model($page,['route'=>['admin.editpageSave',['page'=>$page->id]],'data-parsley-validate'=>'']) !!}
@method('PATCH')
                ...
                <div class="">
                  <div class="row">
                    <div class="col-lg-12 form-group">
                      ...
                      <div class="col-lg-12 form-group @if ($page->static) {{ 'd-none' }} @endif">
              ...
              <div class="tab-pane" id="arabictab">
               ...
               <div class="form-group">
                ...
                <div class="parsley-select" id="slWrapper4">
                  {!! Form::select('country_id', $countries,$page->country_id ,["class"=>"form-control select2-search","data-parsley-class-handler"=>"#slWrapper4","data-parsley-errors-container"=>"#slErrorContainer4","placeholder" => ""]) !!}
            ...
            <div class="col-lg-12">
              ...
              <div class="">
                <div class="added-sections" id="currentsections">
                    ...
                    @php
                     $rsc = (request()->old('sections')) ? request()->old('sections') : $active;
                    @endphp
                    @if (is_countable($rsc) && $sections->count())
                      <div id="section-sort">
                        @foreach ($rsc as $em)
                         ...
                         @endphp
                          @if (!is_null($section) && $section->id == $em)
        ...
        <div class="card-body">
          ...
          <div class="parsley-select" id="slWrapper2">
            {!! Form::select('status', [
              1 => "Active",
              0 => "Inactive",
            ],$page->status, ["class"=>"form-control select2-no-search","data-parsley-class-handler"=>"#slWrapper2","data-parsley-errors-container"=>"#slErrorContainer2","data-placeholder"=>"Choose Page Status","required"=>"required"]) !!}
          ...
          <div class="parsley-checkbox" id="cbWrapper">
              <label class="ckbox mg-b-5">
                {!! Form::checkbox('static', 2, $page->static) !!}
                <span>Yes</span>
              </label>
          </div>
