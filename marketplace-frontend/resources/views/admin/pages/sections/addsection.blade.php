...
<!-- End Page Header -->
{!! Form::open(['route'=>'admin.addsectionSave','method'=>'POST','data-parsley-validate'=>'']) !!}
<div class="row">
  <div class="col-md-8 col-sm-12">
    <div class="card custom-card">
      <div class="card-body">
        <div>
          <h6 class="card-title mb-2">Section Fields</h6>
    ...
    <div class="card custom-card main-content-body-profile">
      ...
      <div class="card-body tab-content h-100">
        <div class="tab-pane active" id="englishtab">
              ...
              <p class="text-muted card-sub-title">Section content in english here.</p>
            </div>
						<textarea name="content:en" class="summernote">{{old('content:en')}}</textarea>

        </div>
        <div class="tab-pane" id="arabictab">
            <div>
              <h6 class="card-title mb-1">Arabic Translations</h6>
              <p class="text-muted card-sub-title">Section content in arabic here.</p>
            </div>
            <textarea name="content:ar" class="summernote">{{old('content:ar')}}</textarea>
  ...
  <div class="col-md-4 col-sm-12 d-none d-xl-block custom-leftnav">
    <div class="main-content-left-components">
      <div class="card custom-card">
        <div class="card-body">
          <h6 class="card-title mb-1">Section Actions</h6>
