...
<!-- End Page Header -->
{!! Form::open(['route'=>'admin.widgets.store','method'=>'POST','data-parsley-validate'=>'']) !!}
<div class="row">
          ...
          <div class="">
            <div class="row">
              <div class="col-lg-12 form-group">
                ...
                {!! Form::text('unique_key', null, ["class"=>"form-control","placeholder"=>"Enter Unique Key eg:footer-about-us,links-widget, etc.","required"=>"required"]) !!}
              </div>
            </div>
      ...
      <div class="card-body tab-content h-100">
        <div class="tab-pane active" id="englishtab">
              ...
              <p class="text-muted card-sub-title">Widget content in english here.</p>
						...
						<textarea name="body:en" class="summernote">{{old('body:en')}}</textarea>
        ...
        <div class="tab-pane" id="arabictab">
            ...
            <textarea name="body:ar" class="summernote">{{old('body:ar')}}</textarea>
