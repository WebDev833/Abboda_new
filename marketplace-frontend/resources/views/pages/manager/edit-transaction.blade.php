...
<div class="roms--document" id="createTransaction">
        {!! Form::model($transaction,['route'=>['manager.editTransaction',$transaction->id],'class'=>'roms--user-forms']) !!}
        @method('PATCH')
        <h4 class="mb-5">Edit Transaction : #{!! $transaction->id !!}</h4>
        ...
        <div class="form-group submit">
            <button type="submit" class="ps-btn">Update Transaction</button>
        </div>
    {!! Form::close() !!}
</div>
