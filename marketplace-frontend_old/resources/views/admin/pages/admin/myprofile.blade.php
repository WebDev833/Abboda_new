...
<!-- End Page Header -->
{!! Form::model($user, ['route'=>['admin.myprofilesave'],'data-parsley-validate'=>'']) !!}
@method('PATCH')
<div class="row">
  <div class="col-md-8 col-sm-12">
    <div class="card custom-card">
      <div class="card-body">
        <div>
          <h6 class="card-title mb-2">Admin Fields</h6>
  ...
  <div class="col-md-4 col-sm-12 d-xl-block custom-leftnav">
    <div class="main-content-left-components">
      <div class="card custom-card">
        <div class="card-body">
          <h6 class="card-title mb-1">Admin Image</h6>
  ...
  var dz_user_avatar = $(".dropzone.mavatar").dropzone({
          ...
          removedfile: function (file) {
              dzRemoveFile(
                  ...
                  'avatar', '{!! isset($user) ? $user->id : 0 !!}', '{{route("admin.mediadelete")}}', '{!! csrf_token() !!}'
              );
          }
      });
