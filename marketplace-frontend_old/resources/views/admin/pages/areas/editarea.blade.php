...
<!-- End Page Header -->
{!! Form::model($area, ['route'=>['admin.editareasave',$area->id],'data-parsley-validate'=>'']) !!}
@method('PATCH')
<div class="row">
          ...
          <div class="">
            <div class="row">
              <div class="col-lg-12 form-group">
                ...
                {!! Form::text('city_id',1, ["class"=>"form-control","placeholder"=>"Enter Name","required"=>"required","readonly"=>"readonly"]) !!}
              </div>
              <div class="col-lg-12 form-group">
        ...
        <div class="card-body">
          ...
          <div class="parsley-checkbox" id="cbWrapper">
              <label class="ckbox mg-b-5">
                {!! Form::checkbox('active', 1, $area->active) !!}
                <span>Active</span>
              </label>
          </div>
          <div class="mg-t-20">
