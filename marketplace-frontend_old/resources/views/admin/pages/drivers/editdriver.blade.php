          ...
          <div class="">
            <div class="row">
              ...
              <div class="col-lg-12 form-group">
                ...
                {!! Form::text('age',$driver->driverprofile->age, ["class"=>"form-control","placeholder"=>"Enter age","required"=>"required"]) !!}
              </div>
              <div class="col-lg-12 form-group">
                <label class="form-label">Area: <span class="tx-danger">*</span></label>
                <div class="parsley-select" id="slWrapper3">
                  {!! Form::select('area_id', $areas, $driver->driverprofile->area_id,["class"=>"form-control select2-search","data-parsley-class-handler"=>"#slWrapper3","data-parsley-errors-container"=>"#slErrorContainer3","data-placeholder"=>"select Area","required"=>"required"]) !!}
                    <div id="slErrorContainer3"></div>
                </div>
              </div>
              <div class="col-lg-12 form-group">
                <label class="form-label">Vehicle Type: <span class="tx-danger">*</span></label>
                {!! Form::text('vehicle_no', $driver->driverprofile->vehicle_no, ["class"=>"form-control","placeholder"=>"Vehicle type","required"=>"required"]) !!}
              </div>
              <div class="col-lg-12 form-group">
                <label class="form-label">Gender: <span class="tx-danger">*</span></label>
                <div class="parsley-select" id="slWrapper2">
                  {!! Form::select('gender',['male'=>'Male','female'=>'Female','other'=>'Other'],$driver->driverprofile->gender, ["class"=>"form-control select2-no-search","data-parsley-class-handler"=>"#slWrapper2","data-parsley-errors-container"=>"#slErrorContainer2","data-placeholder"=>"select Gender","required"=>"required"]) !!}
