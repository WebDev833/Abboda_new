...
<!-- End Page Header -->
{!! Form::model($section,['route'=>['admin.editsectionSave',['section'=>$section->id]],'data-parsley-validate'=>'']) !!}
@method('PATCH')
    ...
    <div class="card custom-card main-content-body-profile">
      ...
      <div class="card-body tab-content h-100">
        <div class="tab-pane active" id="englishtab">
            ...
            {!! Form::textarea('content:en', null, ['class'=>'summernote']) !!}
        ...
        <div class="tab-pane" id="arabictab">
            ...
            {!! Form::textarea('content:ar', null, ['class'=>'summernote']) !!}
        </div>
      </div>
    </div>
