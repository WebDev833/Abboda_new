            ...
            <div class="ps-section__wrapper">
                <div class="ps-section__left @if($frontSettings['showProfileSidebar'] == false) {{ 'd-none'}} @endif ">
                    <div class="ps-block--vendor">
                        <div class="ps-block__thumbnail"><img src="{{  asset(config('roms.dashboard.defaultManagerImage'))}}" alt="ABBODA">
                        </div>
                        <div class="ps-block__container">
                            ...
                            <div class="ps-block__footer">
                                <a class="ps-btn ps-btn--fullwidth" href="{{route('manager.editProfilepage')}}"><i class="fa fa-pencil"></i> Edit Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
