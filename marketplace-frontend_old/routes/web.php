...
Route::group(['prefix' => 'user', 'middleware' => 'customer'], function () {
     ...
     * Update Cart Items
     */
    Route::get('/add-to-cart/{product}', 'UserController@addItemToCart')->name('addtocartpage');
  ...
  //  Route::get('/shipping', 'UserController@myShipping')->name('shippingpage');
    ...
    Route::get('/order-confirmation', 'UserController@myOrderPlacedConfirmation')->name('orderconfirmationpage');
...
Route::group(['prefix' => 'driver', 'middleware' => 'driver'], function () {
    ...
    Route::get('/my-dashboard', 'DriverController@dashboard')->name('driver.dashboard');
 ...
 * Store Types
 */
Route::get('/restaurants', 'StaticPagesController@allRestaurants')->name('restaurants');
